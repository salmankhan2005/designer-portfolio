...
#### Are you struggling to create a professional portfolio website? Look no further! You can use this Graphic Designer Portfolio template and create your very own personalized portfolio today! My website is designed to be user-friendly and easily customizable, making it perfect for graphic designers, creative professionals, and freelancers.
...
```bash
git clone https://github.com/<YOUR GITHUB USERNAME>/graphic-designer-portfolio.git
...
export const personalData = {
  name: "ALEX RIVERA",
  profile: "/profile.png",
  designation: "Creative Graphic Designer • Brand Identity Specialist",
  description: "I'm a passionate graphic designer with 5+ years of experience...",
  email: "alex.rivera@designstudio.com",
  phone: "+1 (555) 123-4567",
  address: "Creative District, Design City, CA 90210",
  github: "https://github.com/alexriveradesign",
  linkedIn: "https://www.linkedin.com/in/alexriveradesign",
  resume: "...",
};
```

The portfolio is now customized for graphic designers with sections for design projects, creative skills, and design education.
